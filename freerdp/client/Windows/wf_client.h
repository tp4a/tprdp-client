...
struct wf_context
{
	...
	// Apex {{
	// progress dialog-box handle. maybe a UI-thread.
	HANDLE startboxThread;
	DWORD startboxThreadId;
	HWND hStartbox;
	HWND hStartbox_Info;
	HFONT hStartboxFont;
	int startboxTimer;
...
// Apex {{
FREERDP_API int freerdp_create_start_box(wfContext* wfc);
FREERDP_API int freerdp_destroy_start_box(wfContext* wfc);
// }}
